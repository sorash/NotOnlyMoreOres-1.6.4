...
public class ItemYellowStaff extends ItemSword{

	public ItemYellowStaff(int par1) {
		super(par1, MoreOres.toolYellow);
		setMaxDamage(150);
	}

	public void registerIcons(IconRegister iconRegister) {
		itemIcon = iconRegister.registerIcon("moreores:yellowStaff");
	}
