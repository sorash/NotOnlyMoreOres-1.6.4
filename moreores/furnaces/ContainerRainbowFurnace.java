...
{
    private TileEntityRainbowFurnace furnace;
    private int lastCookTime = 0;
    private int lastBurnTime = 0;
    private int lastItemBurnTime = 0;

    public ContainerRainbowFurnace(InventoryPlayer par1InventoryPlayer, TileEntityRainbowFurnace par2TileEntityFurnace)
    {
        ...
        this.addSlotToContainer(new SlotRainbowFurnace(par1InventoryPlayer.player, par2TileEntityFurnace, 2, 116, 35));
        int i;
