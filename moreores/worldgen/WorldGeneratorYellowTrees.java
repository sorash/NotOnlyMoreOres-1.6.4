...
public class WorldGeneratorYellowTrees extends WorldGenerator
{
    ...
    public WorldGeneratorYellowTrees(boolean par1)
    {
        this(par1, 4, 0, 0, false);
    }

    public WorldGeneratorYellowTrees(boolean par1, int par2, int par3, int par4, boolean par5)
    {
        super(par1);
    ...
    public boolean generate(World par1World, Random par2Random, int par3, int par4, int par5)
    {
        ...
        if (par4 >= 1 && par4 + l + 1 <= 256)
        {
            ...
            else
            {
                ...
                boolean isSoil = (soil != null && soil.canSustainPlant(par1World, par3, par4 - 1, par5, ForgeDirection.UP, (BlockYellowSapling)MoreOres.yellowSapling));
                ...
                if (isSoil && par4 < 256 - l - 1)
                {
                        ...
                        for (j2 = par3 - i2; j2 <= par3 + i2; ++j2)
                        {
                            ...
                            for (int l2 = par5 - i2; l2 <= par5 + i2; ++l2)
                            {
                                ...
                                if (Math.abs(k2) != i2 || Math.abs(i3) != i2 || par2Random.nextInt(2) != 0 && k1 != 0)
                                {
                                    ...
                                    {
                                        this.setBlockAndMetadata(par1World, j2, j1, l2, MoreOres.yellowLeaves.blockID, this.metaLeaves);
                                    }
                                }
                            }
                        }
                    ...
                    for (j1 = 0; j1 < l; ++j1)
                    {
                        ...
                        {
                            this.setBlockAndMetadata(par1World, par3, par4 + j1, par5, MoreOres.yellowLog.blockID, this.metaWood);

                            if (this.vinesGrow && j1 > 0)
                            {
                                if (par2Random.nextInt(3) > 0 && par1World.isAirBlock(par3 - 1, par4 + j1, par5))
                                {
                                    this.setBlockAndMetadata(par1World, par3 - 1, par4 + j1, par5, MoreOres.yellowVines.blockID, 8);
                                }

                                if (par2Random.nextInt(3) > 0 && par1World.isAirBlock(par3 + 1, par4 + j1, par5))
                                {
                                    this.setBlockAndMetadata(par1World, par3 + 1, par4 + j1, par5, MoreOres.yellowVines.blockID, 2);
                                }

                                if (par2Random.nextInt(3) > 0 && par1World.isAirBlock(par3, par4 + j1, par5 - 1))
                                {
                                    this.setBlockAndMetadata(par1World, par3, par4 + j1, par5 - 1, MoreOres.yellowVines.blockID, 1);
                                }

                                if (par2Random.nextInt(3) > 0 && par1World.isAirBlock(par3, par4 + j1, par5 + 1))
                                {
                                    this.setBlockAndMetadata(par1World, par3, par4 + j1, par5 + 1, MoreOres.yellowVines.blockID, 4);
                                }
                            }
                        }
                    }
    ...
    {
        this.setBlockAndMetadata(par1World, par2, par3, par4, MoreOres.yellowVines.blockID, par5);
        int i1 = 4;
