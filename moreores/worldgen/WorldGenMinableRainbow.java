...
public class WorldGenMinableRainbow extends WorldGenerator
{
	...
	public WorldGenMinableRainbow(int par1, int par2)
	{
		this(par1, par2, MoreOres.rainbowStone.blockID);
	}

	public WorldGenMinableRainbow(int par1, int par2, int par3)
	{
	...
	public WorldGenMinableRainbow(int id, int meta, int number, int target)
	{
