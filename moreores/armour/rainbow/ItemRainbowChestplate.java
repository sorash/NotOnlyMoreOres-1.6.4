...
public class ItemRainbowChestplate extends ItemArmor{
	
	private EnumArmorMaterial material;

	public ItemRainbowChestplate(int par1,
			EnumArmorMaterial par2EnumArmorMaterial, int par3, int par4) {
		super(par1, par2EnumArmorMaterial, par3, par4);
	}
	public void registerIcons(IconRegister iconRegister) {
		itemIcon = iconRegister.registerIcon("moreores:rainbowChestplate");
	}
