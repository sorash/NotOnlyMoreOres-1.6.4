...
{
	public static final String[] woodType = new String[] {"blue"};
	public static final String[] treeTextureTypes = new String[] {"moreores:blueTree_side"};
	@SideOnly(Side.CLIENT)
	private Icon tree_top;
    private Icon tree_side;
	private Icon[] iconArray;

	public BlockBlueLog(int par1)
	{
    ...
    {
        this.tree_top = par1IconRegister.registerIcon("moreores:blueTree_top");
        this.tree_side = par1IconRegister.registerIcon("moreores:blueTree_side");
