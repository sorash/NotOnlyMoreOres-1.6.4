...
public class BlockBlueCrop extends BlockCrops
{
    @SideOnly(Side.CLIENT)
    private Icon[] iconArray;

    public BlockBlueCrop(int par1)
    {
        super(par1);
    ...
    {
        return MoreOres.blueSeeds.itemID;
    }
    ...
    {
        return MoreOres.blueChunklet.itemID;
    }
    ...
    public void registerIcons(IconRegister par1IconRegister)
    {
        ...
        {
            this.iconArray[i] = par1IconRegister.registerIcon("moreores:blueCrop_" + i);
        }
    }
}
