...
public class BlockBlueDoor extends Block
{
    ...
    public BlockBlueDoor(int par1, Material par2Material)
    {
    ...
    {
        return (par1 & 8) != 0 ? 0 : (this.blockMaterial == Material.iron ? MoreOres.blueDoorItem.itemID : MoreOres.blueWoodDoorItem.itemID);
    }
    ...
    {
        return this.blockMaterial == Material.iron ? MoreOres.blueDoorItem.itemID : MoreOres.blueWoodDoorItem.itemID;
    }
