...
public class BlockBlackDoor extends Block
{
    private static final String[] doorIconNames = new String[] {"moreores:blackDoor_bottom", "moreores:blackDoor_top"};
    ...
    public BlockBlackDoor(int par1, Material par2Material)
    {
    ...
    {
        return (par1 & 8) != 0 ? 0 : (MoreOres.blackDoorItem.itemID);
    }
