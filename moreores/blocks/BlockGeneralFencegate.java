...
public class BlockGeneralFencegate extends BlockFenceGate
{
	
	private Block icon;
	
    public BlockGeneralFencegate(int par1, Block par2)
    {
        super(par1);
        this.icon = par2;
    }
    ...
    {
        return this.icon.getBlockTextureFromSide(par1);
    }
