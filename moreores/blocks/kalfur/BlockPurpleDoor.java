...
public class BlockPurpleDoor extends Block
{
    private static final String[] doorIconNames = new String[] {"moreores:purpleDoor_bottom", "moreores:purpleDoor_top"};
    ...
    public BlockPurpleDoor(int par1, Material par2Material)
    {
    ...
    {
        return (par1 & 8) != 0 ? 0 : (MoreOres.purpleDoorItem.itemID);
    }
