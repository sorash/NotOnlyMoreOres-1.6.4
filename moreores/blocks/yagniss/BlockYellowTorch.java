...
public class BlockYellowTorch extends Block
{
    public BlockYellowTorch(int par1)
    {
    ...
    public void randomDisplayTick(World par1World, int par2, int par3, int par4, Random par5Random)
    {
        ...
        if (l == 1)
        {
            MoreOresParticleEffects.spawnParticle("yellowSmoke", d0 - d4, d1 + d3, d2, 0.0D, 0.0D, 0.0D);
            MoreOresParticleEffects.spawnParticle("yellowFlame", d0 - d4, d1 + d3, d2, 0.0D, 0.0D, 0.0D);
        }
        else if (l == 2)
        {
        	MoreOresParticleEffects.spawnParticle("yellowSmoke", d0 + d4, d1 + d3, d2, 0.0D, 0.0D, 0.0D);
        ...
        {
        	MoreOresParticleEffects.spawnParticle("yellowSmoke", d0, d1, d2, 0.0D, 0.0D, 0.0D);
        	MoreOresParticleEffects.spawnParticle("yellowFlame", d0, d1, d2, 0.0D, 0.0D, 0.0D);
        }
    }
    
	@Override
	public void registerIcons(IconRegister reg){
		this.blockIcon = reg.registerIcon("moreores:yellowTorch");
	}
}
