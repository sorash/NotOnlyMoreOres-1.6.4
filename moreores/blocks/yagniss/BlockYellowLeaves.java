...
public class BlockYellowLeaves extends BlockLeavesBase implements IShearable
{
    public static final String[] YELLOW_LEAF_TYPES = new String[] {"yellow"};
    public static final String[][] yellowfield_94396_b = new String[][] {{"moreores:yellowLeaves"}};
    @SideOnly(Side.CLIENT)
    private int field_94394_cP;
    private Icon[][] iconArray = new Icon[2][];
    int[] adjacentTreeBlocks;

    public BlockYellowLeaves(int par1)
    {
    ...
    {
        return MoreOres.yellowSapling.blockID;
    }
    ...
    public void dropBlockAsItemWithChance(World par1World, int par2, int par3, int par4, int par5, float par6, int par7)
    {
        if (!par1World.isRemote)
        {
            ...
            {
                this.dropBlockAsItem_do(par1World, par2, par3, par4, new ItemStack(MoreOres.lemon, 1, 0));
            }
        }
    }
	...
	public void registerIcons(IconRegister reg){
		this.blockIcon = reg.registerIcon("moreores:yellowLeaves");
	}
