...
public class BlockYellowLog extends Block
{
	public static final String[] woodType = new String[] {"yellow"};
	public static final String[] treeTextureTypes = new String[] {"moreores:yellowTree_side"};
	@SideOnly(Side.CLIENT)
	private Icon tree_top;
    private Icon tree_side;
	private Icon[] iconArray;

	public BlockYellowLog(int par1)
	{
    ...
    {
        this.tree_top = par1IconRegister.registerIcon("moreores:yellowTree_top");
        this.tree_side = par1IconRegister.registerIcon("moreores:yellowTree_side");
