...
public class BlockYellowDoor extends Block
{
    ...
    public BlockYellowDoor(int par1, Material par2Material)
    {
    ...
    {
        return (par1 & 8) != 0 ? 0 : (this.blockMaterial == Material.iron ? MoreOres.yellowDoorItem.itemID : MoreOres.yellowWoodDoorItem.itemID);
    }
    ...
    {
        return this.blockMaterial == Material.iron ? MoreOres.yellowDoorItem.itemID : MoreOres.yellowWoodDoorItem.itemID;
    }
