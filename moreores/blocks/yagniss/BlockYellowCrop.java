...
public class BlockYellowCrop extends BlockCrops
{
    @SideOnly(Side.CLIENT)
    private Icon[] iconArray;

    public BlockYellowCrop(int par1)
    {
        super(par1);
    ...
    {
        return MoreOres.yellowSeeds.itemID;
    }
    ...
    {
        return MoreOres.yellowChunklet.itemID;
    }
    ...
    public void registerIcons(IconRegister par1IconRegister)
    {
        ...
        {
            this.iconArray[i] = par1IconRegister.registerIcon("moreores:yellowCrop_" + i);
        }
    }
}
