...
public class BlockGreenCrop extends BlockCrops
{
    @SideOnly(Side.CLIENT)
    private Icon[] iconArray;

    public BlockGreenCrop(int par1)
    {
        super(par1);
    ...
    {
        return MoreOres.greenSeeds.itemID;
    }
    ...
    {
        return MoreOres.greenChunklet.itemID;
    }
    ...
    public void registerIcons(IconRegister par1IconRegister)
    {
        ...
        {
            this.iconArray[i] = par1IconRegister.registerIcon("moreores:greenCrop_" + i);
        }
    }
}
