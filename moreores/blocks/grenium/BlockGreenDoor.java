...
public class BlockGreenDoor extends Block
{
    ...
    {
        return (par1 & 8) != 0 ? 0 : (this.blockMaterial == Material.iron ? MoreOres.greenDoorItem.itemID : MoreOres.greenWoodDoorItem.itemID);
    }
    ...
    {
        return this.blockMaterial == Material.iron ? MoreOres.greenDoorItem.itemID : MoreOres.greenWoodDoorItem.itemID;
    }
