...
public class BlockGreenLog extends Block
{
	public static final String[] woodType = new String[] {"green"};
	public static final String[] treeTextureTypes = new String[] {"moreores:greenTree_side"};
	@SideOnly(Side.CLIENT)
	private Icon tree_top;
    private Icon tree_side;
	private Icon[] iconArray;

	public BlockGreenLog(int par1)
	{
    ...
    {
        this.tree_top = par1IconRegister.registerIcon("moreores:greenTree_top");
        this.tree_side = par1IconRegister.registerIcon("moreores:greenTree_side");
