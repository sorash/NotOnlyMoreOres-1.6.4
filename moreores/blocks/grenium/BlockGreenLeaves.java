...
{
    public static final String[] GREEN_LEAF_TYPES = new String[] {"green"};
    public static final String[][] greenfield_94396_b = new String[][] {{"moreores:greenLeaves"}};
    ...
    {
        return MoreOres.greenSapling.blockID;
    }
    ...
    public void dropBlockAsItemWithChance(World par1World, int par2, int par3, int par4, int par5, float par6, int par7)
    {
        if (!par1World.isRemote)
        {
            ...
            {
                this.dropBlockAsItem_do(par1World, par2, par3, par4, new ItemStack(MoreOres.greenApple, 1, 0));
            }
        }
    }
	...
	public void registerIcons(IconRegister reg){
		this.blockIcon = reg.registerIcon("moreores:greenLeaves");
	}
