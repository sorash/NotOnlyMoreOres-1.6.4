...
public class BlockOrangeTorch extends Block
{
    public BlockOrangeTorch(int par1)
    {
    ...
    public void randomDisplayTick(World par1World, int par2, int par3, int par4, Random par5Random)
    {
        ...
        {
        	MoreOresParticleEffects.spawnParticle("orangeSmoke", d0, d1 + d3, d2 - d4, 0.0D, 0.0D, 0.0D);
        	MoreOresParticleEffects.spawnParticle("orangeFlame", d0, d1 + d3, d2 - d4, 0.0D, 0.0D, 0.0D);
        }
        else if (l == 4)
        {
        	MoreOresParticleEffects.spawnParticle("orangeSmoke", d0, d1 + d3, d2 + d4, 0.0D, 0.0D, 0.0D);
        ...
        {
        	MoreOresParticleEffects.spawnParticle("orangeSmoke", d0, d1, d2, 0.0D, 0.0D, 0.0D);
        	MoreOresParticleEffects.spawnParticle("orangeFlame", d0, d1, d2, 0.0D, 0.0D, 0.0D);
        }
    }
    
	@Override
	public void registerIcons(IconRegister reg){
		this.blockIcon = reg.registerIcon("moreores:orangeTorch");
	}
}
