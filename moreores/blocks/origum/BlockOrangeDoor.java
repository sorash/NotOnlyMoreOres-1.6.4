...
public class BlockOrangeDoor extends Block
{
    ...
    public BlockOrangeDoor(int par1, Material par2Material)
    {
    ...
    {
        return (par1 & 8) != 0 ? 0 : (this.blockMaterial == Material.iron ? MoreOres.orangeDoorItem.itemID : MoreOres.orangeWoodDoorItem.itemID);
    }
    ...
    {
        return this.blockMaterial == Material.iron ? MoreOres.orangeDoorItem.itemID : MoreOres.orangeWoodDoorItem.itemID;
    }
