...
public class BlockOrangeCrop extends BlockCrops
{
    ...
    public BlockOrangeCrop(int par1)
    {
        super(par1);
    ...
    {
        return MoreOres.orangeSeeds.itemID;
    }
    ...
    {
        return MoreOres.orangeChunklet.itemID;
    }
    ...
    public void registerIcons(IconRegister par1IconRegister)
    {
        ...
        {
            this.iconArray[i] = par1IconRegister.registerIcon("moreores:orangeCrop_" + i);
        }
    }
}
