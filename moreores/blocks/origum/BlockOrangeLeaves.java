...
{
    public static final String[] ORANGE_LEAF_TYPES = new String[] {"orange"};
    public static final String[][] orangefield_94396_b = new String[][] {{"moreores:orangeLeaves"}};
    ...
    {
        return MoreOres.orangeSapling.blockID;
    }
    ...
    public void dropBlockAsItemWithChance(World par1World, int par2, int par3, int par4, int par5, float par6, int par7)
    {
        if (!par1World.isRemote)
        {
            ...
            {
                this.dropBlockAsItem_do(par1World, par2, par3, par4, new ItemStack(MoreOres.orange, 1, 0));
            }
        }
    }
	...
	public void registerIcons(IconRegister reg){
		this.blockIcon = reg.registerIcon("moreores:orangeLeaves");
	}
