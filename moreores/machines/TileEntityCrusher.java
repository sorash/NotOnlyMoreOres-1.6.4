...
public class TileEntityCrusher extends TileEntity implements ISidedInventory
{
    ...
    public void readFromNBT(NBTTagCompound par1NBTTagCompound)
    {
        ...
        if (par1NBTTagCompound.hasKey("Crusher"))
        {
            this.field_94130_e = par1NBTTagCompound.getString("Crusher");
        }
    }
    ...
    public void writeToNBT(NBTTagCompound par1NBTTagCompound)
    {
        ...
        {
            par1NBTTagCompound.setString("Crusher", this.field_94130_e);
        }
    }
    ...
    public static int getItemBurnTime(ItemStack par0ItemStack)
    {
        ...
        else
        {
            ...
            if (i == MoreOres.crusher.itemID) return 600;
