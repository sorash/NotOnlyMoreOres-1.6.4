...
{
	private static final ResourceLocation field_110410_t = new ResourceLocation("moreores", "textures/gui/extractor.png");
    private TileEntityExtractor furnaceInventory;

    public GuiExtractor(InventoryPlayer par1InventoryPlayer, TileEntityExtractor tile_entity)
    {
        super(new ContainerExtractor(par1InventoryPlayer, tile_entity));
