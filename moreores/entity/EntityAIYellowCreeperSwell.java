...
public class EntityAIYellowCreeperSwell extends EntityAIBase
{
    /** The creeper that is swelling. */
    EntityYellowCreeper swellingCreeper;
    ...
    public EntityAIYellowCreeperSwell(EntityYellowCreeper entityYellowCreeper)
    {
        this.swellingCreeper = entityYellowCreeper;
        this.setMutexBits(1);
    }
