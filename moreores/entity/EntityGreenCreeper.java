...
public class EntityGreenCreeper extends EntityMob
{
	/**
	...
	private int fuseTime = 23;

	/** Explosion radius for this creeper. */
	private int explosionRadius = 10;

	public EntityGreenCreeper(World par1World)
	{
		super(par1World);
        this.getNavigator().setAvoidsWater(true);
		this.tasks.addTask(1, new EntityAISwimming(this));
		this.tasks.addTask(2, new EntityAIGreenCreeperSwell(this));
	...
	{
		return MoreOres.greenNugget.itemID;
	}
	...
	{
		return StatCollector.translateToLocal("\u00A7aGreen Creeper");
	}
}
