...
public class EntityBlueSlime extends EntityLiving implements IMob
{
        ...
        if (this.onGround && !flag)
        {
            ...
            for (int j = 0; j < i * 8; ++j)
            {
                ...
                if(this.worldObj.isRemote){
                	MoreOresParticleEffects.spawnParticle("blueSlime", this.posX + (double)f2, this.boundingBox.minY, this.posZ + (double)f3, 0.0D, 0.0D, 0.0D);
                }
            }
    ...
    {
        return this.getSlimeSize() == 1 ? MoreOres.blueJelly.itemID : 0;
    }
	...
	{
		return StatCollector.translateToLocal("\u00A79Blue Slime");
	}
}
