...
public class ItemBlueDoor extends Item
{
    private Material doorMaterial;

    public ItemBlueDoor(int par1, Material par2Material)
    {
        super(par1);
	...
	public void registerIcons(IconRegister iconRegister){
		itemIcon = iconRegister.registerIcon("moreores:blueDoor");
	}
}
