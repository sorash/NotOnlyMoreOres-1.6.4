...
{
	public static final String[] woodType = new String[] {"rainbow"};
	public static final String[] treeTextureTypes = new String[] {"moreores:rainbowTree_side"};
	@SideOnly(Side.CLIENT)
	private Icon tree_top;
    private Icon tree_side;
	private Icon[] iconArray;

	public BlockRainbowLog(int par1)
	{
    ...
    {
        this.tree_top = par1IconRegister.registerIcon("moreores:rainbowTree_top");
        this.tree_side = par1IconRegister.registerIcon("moreores:rainbowTree_side");
