...
public class BlockRainbowWalls extends BlockWall
{
    /** The types of the wall. */
    public static final String[] types = new String[] {"rainbow"};

    public BlockRainbowWalls(int par1, Block par2Block)
    {
    ...
    {
        return par2 == 1 ? MoreOres.rainbowBlock.getBlockTextureFromSide(par1) : MoreOres.rainbowBlock.getBlockTextureFromSide(par1);
    }
