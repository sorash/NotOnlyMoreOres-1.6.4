...
public class BlockRainbowFire extends BlockFire
{
    ...
    public BlockRainbowFire(int par1, Material mat)
    {
        super(par1);
    ...
    {
        if (par1World.provider.dimensionId > 0 || par1World.getBlockId(par2, par3 - 1, par4) != MoreOres.purpleBlock.blockID || !MoreOres.rainbowPortal.tryToCreatePortal(par1World, par2, par3, par4))
        {
            if (!par1World.doesBlockHaveSolidTopSurface(par2, par3 - 1, par4) && !this.canNeighborBurn(par1World, par2, par3, par4))
            {
                par1World.setBlockToAir(par2, par3, par4);
    ...
    public void randomDisplayTick(World par1World, int par2, int par3, int par4, Random par5Random)
    {
        ...
        if (!par1World.doesBlockHaveSolidTopSurface(par2, par3 - 1, par4) && !MoreOres.rainbowFire.canBlockCatchFire(par1World, par2, par3 - 1, par4, UP))
        {
            if (MoreOres.rainbowFire.canBlockCatchFire(par1World, par2 - 1, par3, par4, EAST))
            {
                for (l = 0; l < 2; ++l)
                {
            ...
            if (MoreOres.rainbowFire.canBlockCatchFire(par1World, par2 + 1, par3, par4, WEST))
            {
                for (l = 0; l < 2; ++l)
                {
            ...
            if (MoreOres.rainbowFire.canBlockCatchFire(par1World, par2, par3, par4 - 1, SOUTH))
            {
                for (l = 0; l < 2; ++l)
                {
            ...
            if (MoreOres.rainbowFire.canBlockCatchFire(par1World, par2, par3, par4 + 1, NORTH))
            {
                for (l = 0; l < 2; ++l)
                {
                    f = (float)par2 + par5Random.nextFloat();
            ...
            if (MoreOres.rainbowFire.canBlockCatchFire(par1World, par2, par3 + 1, par4, DOWN))
            {
                for (l = 0; l < 2; ++l)
                {
                    f = (float)par2 + par5Random.nextFloat();
