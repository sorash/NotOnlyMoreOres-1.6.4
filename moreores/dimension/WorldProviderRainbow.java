...
public class WorldProviderRainbow extends WorldProvider
{
	...
	{
		this.worldChunkMgr = new WorldChunkManagerHell(MoreOres.rainbowBiome, this.dimensionId, this.dimensionId);
		this.dimensionId = MoreOresConfig.rainbowDimID;
		this.hasNoSky = false;
	}
	
	public IChunkProvider createChunkGenerator()
	{
		return new ChunkProviderRainbow(this.worldObj, this.worldObj.getSeed(), false);
	}
	...
	{
		return "/mods/moreores/textures/rainbowSun.png";
	}
	...
	{
		if (this instanceof WorldProviderRainbow)
		{
			return "Entering Rainbow Dimension";
		}
		return null;
	}
    ...
    public String getDepartMessage()
    {
        if (this instanceof WorldProviderRainbow)
        {
            return "Leaving Rainbow Dimension";
        }
        return null;
    }
