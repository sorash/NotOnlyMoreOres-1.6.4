...
public class BlockRainbowLeaves extends BlockLeavesBase implements IShearable
{
    public static final String[] rainbow_LEAF_TYPES = new String[] {"rainbow"};
    public static final String[][] rainbowfield_94396_b = new String[][] {{"moreores:rainbowLeaves"}};
    @SideOnly(Side.CLIENT)
    private int field_94394_cP;
    private Icon[][] iconArray = new Icon[2][];
    int[] adjacentTreeBlocks;

    public BlockRainbowLeaves(int par1)
    {
        super(par1, Material.leaves, false);
        this.setTickRandomly(true);
        blockFireSpreadSpeed[this.blockID] = 7;
        blockFlammability[this.blockID] = 25;
    }
    ...
    {
        return MoreOres.rainbowSapling.blockID;
    }
    ...
    public void dropBlockAsItemWithChance(World par1World, int par2, int par3, int par4, int par5, float par6, int par7)
    {
        if (!par1World.isRemote)
        {
            ...
            {
                this.dropBlockAsItem_do(par1World, par2, par3, par4, new ItemStack(MoreOres.superfruit, 1, 0));
            }
        }
    }
	...
	public void registerIcons(IconRegister reg){
		this.blockIcon = reg.registerIcon("moreores:rainbowLeaves");
	}
