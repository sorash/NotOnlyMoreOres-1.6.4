...
public class BlockRainbowSapling extends BlockFlower
{

	public static final String[] WOOD_TYPES = new String[] {"rainbow"};
	public BlockRainbowSapling(int i, int j)
	{
		super(i);
		float var3 = 0.4F;
	...
	public void func_96477_c(World par1World, int par2, int par3, int par4, Random par5Random)
	{
		...
		if ((l & 8) == Block.grass.blockID || (l & 8) == MoreOres.rainbowGrass.blockID)
		{
			...
			for (i1 = 0; i1 >= -1; --i1)
			{
				for (j1 = 0; j1 >= -1; --j1)
				{
					if (this.isSameSapling(par1World, par2 + i1, par3, par4 + j1, 3) && this.isSameSapling(par1World, par2 + i1 + 1, par3, par4 + j1, 3) && this.isSameSapling(par1World, par2 + i1, par3, par4 + j1 + 1, 3) && this.isSameSapling(par1World, par2 + i1 + 1, par3, par4 + j1 + 1, 3))
					{
						...
						object = new WorldGeneratorRainbowTrees(true);
						flag = true;
						break;
					}
				}
	...
	{
		return par1 == Block.grass.blockID || par1 == MoreOres.rainbowGrass.blockID || par1 == Block.dirt.blockID || par1 == MoreOres.rainbowDirt.blockID || par1 == Block.tilledField.blockID;
	}
	
	public void registerIcons(IconRegister reg){
		this.blockIcon = reg.registerIcon("moreores:rainbowSapling");
	}  
}