...
public class BlockRainbowDoor extends Block
{
    ...
    public BlockRainbowDoor(int par1, Material par2Material)
    {
    ...
    public void registerIcons(IconRegister par1IconRegister)
    {
        ...
        this.field_111044_a[0] = par1IconRegister.registerIcon("moreores:" + this.func_111023_E() + "_top");
        this.field_111043_b[0] = par1IconRegister.registerIcon("moreores:" + this.func_111023_E() + "_bottom");
    ...
    {
        return (par1 & 8) != 0 ? 0 : (this.blockMaterial == Material.iron ? MoreOres.rainbowDoorItem.itemID : MoreOres.rainbowWoodDoorItem.itemID);
    }
    ...
    {
        return this.blockMaterial == Material.iron ? MoreOres.rainbowDoorItem.itemID : MoreOres.rainbowWoodDoorItem.itemID;
    }
