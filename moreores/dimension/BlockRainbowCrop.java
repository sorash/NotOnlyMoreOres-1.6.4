...
public class BlockRainbowCrop extends BlockCrops
{
    @SideOnly(Side.CLIENT)
    private Icon[] iconArray;

    public BlockRainbowCrop(int par1)
    {
        super(par1);
    ...
    {
        return MoreOres.rainbowSeeds.itemID;
    }
    ...
    {
        return MoreOres.rainbowChunklet.itemID;
    }
    ...
    public void registerIcons(IconRegister par1IconRegister)
    {
        ...
        {
            this.iconArray[i] = par1IconRegister.registerIcon("moreores:rainbowCrop_" + i);
        }
    }
}
